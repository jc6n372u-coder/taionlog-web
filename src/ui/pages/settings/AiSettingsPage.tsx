      ...
      <main style={{ padding: 16, display: "grid", gap: 16 }}>
        ...
        <section style={styles.card}>
          ...
          <div style={{marginBottom: 16}}>
            <button onClick={() => setShowGeminiHelp(!showGeminiHelp)} style={styles.accordionBtn}>
                {showGeminiHelp ? "▼" : "▶"} APIキーの取得手順を見る
            </button>
            {showGeminiHelp && (
                <div style={styles.helpText}>
                    1. 上記リンクから Google AI Studio にアクセス<br/>
                    2. 「Get API key」ボタンを押す<br/>
                    3. 「Create API key」を選択してキーを生成<br/>
        ...
        <section style={styles.card}>
          ...
          <div style={{marginBottom: 16}}>
            ...
            {showGroqHelp && (
                <div style={styles.helpText}>
                    1. 上記リンクから Groq Console にアクセス<br/>
                    2. 「Create API Key」ボタンを押す<br/>
                    3. 任意の名前(例: app)を入力してSubmit<br/>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  // ★追加スタイル
  linkArea: { fontSize: 13, color: "#666", marginBottom: 8, display: "flex", alignItems: "center", flexWrap: "wrap" },
  link: { color: "#0056b3", fontWeight: "bold", textDecoration: "none" },
  accordionBtn: { background: "none", border: "none", color: "#666", fontSize: 12, cursor: "pointer", padding: 0, display: "flex", alignItems: "center", gap: 4 },
  helpText: { marginTop: 8, padding: 10, background: "#f9fafb", borderRadius: 8, fontSize: 12, color: "#444", lineHeight: "1.6" }
};
